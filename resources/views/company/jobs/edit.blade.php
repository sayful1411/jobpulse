                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12">
                                            ...
                                            <textarea class="@error('description') border border-danger @enderror" name="description" id="summernote"
                                                placeholder="">{{ old('description', $job->description) }}
                                            </textarea>
                                            @error('description')
                                                <div class="mt-1 text-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="form-group col-lg-6 col-md-12 date" data-provide="datepicker">
                                            ...
                                            <input class="@error('expiration_date') border border-danger @enderror"
                                                ...
                                                class="form-control" value="{{ old('expiration_date', $job->expiration_date->format('M d, Y')) }}">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12">
                                            ...
                                            <select class="tags" id="tags" name="tags[]" multiple="multiple">
                                                @foreach ($tags as $tag)
                                                    <option value="{{ $tag->id }}" {{ $job->tags->contains($tag->id) ? 'selected' : '' }}>{{ $tag->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('tags')
                                                <div class="mt-1 text-danger">{{ $message }}</div>
