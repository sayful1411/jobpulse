<div class="user-sidebar">
    ...
    <div class="sidebar-inner">
        <ul class="navigation">
            ...
            <li class="{{ request()->routeIs('company.jobs.create') ? 'active' : '' }}"><a href="{{ route('company.jobs.create') }}"><i
                        class="la la-paper-plane"></i>Post a New Job</a></li>
            <li class="{{ request()->routeIs('company.jobs.*') && !request()->routeIs('company.jobs.create') ? 'active' : '' }}"><a
                    href="{{ route('company.jobs.index') }}"><i class="la la-briefcase"></i> Manage Jobs </a></li>
