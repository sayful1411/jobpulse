                                ...
                                <form method="POST" action="{{ route('candidate.resume.training.store') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            <label>Title</label>
                                            <input type="text" name="title" value="{{ old('title') }}" placeholder="Web Developer">
                                            @error('title')
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <input type="text" name="institute" value="{{ old('institute') }}" placeholder="Ostad Ltd.">
                                            @error('institute')
                                                <div class="mt-1 text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            ...
                                            <input type="text" name="completion_year" value="{{ old('completion_year') }}" placeholder="2024">
